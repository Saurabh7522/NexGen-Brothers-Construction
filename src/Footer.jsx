    ...
    <footer className="bg-gray-900 text-gray-300 py-10 px-4 sm:px-6 lg:px-8">
      <div className="max-w-7xl mx-auto grid grid-cols-1 md:grid-cols-4 gap-8">
        <div className="flex flex-col space-y-4 items-center md:items-start">
          ...
          <p className="text-gray-400 text-sm text-center md:text-left">Building the future with quality and safety.</p>
        </div>
        ...
        <div className="text-center md:text-left">
          ...
          <div className="flex justify-center md:justify-start space-x-5 text-2xl">
            <a href="https://www.instagram.com/nexgen_brothers_construction_/" target="_blank" rel="noopener noreferrer" className="text-gray-400 hover:text-pink-500"><FaInstagram /></a>
            <a href="https://wa.me/7779027110" target="_blank" rel="noopener noreferrer" className="text-gray-400 hover:text-green-500"><FaWhatsapp /></a>
            <a href="https://www.facebook.com/profile.php?id=100064051564663" target="_blank" rel="noopener noreferrer" className="text-gray-400 hover:text-blue-600"><FaFacebookF /></a>
            <a href="https://in.linkedin.com/company/nexgen-for-all-your-industrial-service-needs-ba9a7026b" target="_blank" rel="noopener noreferrer" className="text-gray-400 hover:text-blue-400"><FaLinkedinIn /></a>
            <a href="mailto:admin@nexgenbrothersconstruction.com" target="_blank" rel="noopener noreferrer" className="text-gray-400 hover:text-blue-400"><FaEnvelope /></a>
            <a href="https://x.com/NexGenBrothers" target="_blank" rel="noopener noreferrer" className="text-gray-400 hover:text-blue-400"><FaTwitter /></a>
          </div>
        </div>
      </div>
